...
exports.run = async (client, message, args) => {
    ...
    if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(Config.setDescription(`**Bu yetkiyi kullanabilmen için \`Yönetici\` yetkisine sahip olmalısın.**`)).then(x => x.delete({timeout: Config.Embed.Timeout}));
...
exports.help = {
  name: 'kilit',
  description: 'Komutu kullandığınız kanalı kilitler - açar. / Stans was here',
  usage: 'kilit'
};