...
.setAuthor('Yardım Menüsü', message.author.avatarURL({dynamic: true}))
  ...
  .setDescription(`> **• | Merhaba!** ${message.author} Stans "kayıt botunun yardım menüsüne hoşgeldin komutlar aşağıda.`)
...
exports.help = {
  name: 'yardım',
  description: 'Yardım menüsünü gösterir. / Stans was here',
  usage: 'yardım'
};